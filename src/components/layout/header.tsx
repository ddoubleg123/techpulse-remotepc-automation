...
export default function Header() {
  ...
  return (
    <header style={{
      ...
      {/* Right: search + bell + theme toggle — NO avatar */}
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        {/* Search */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 14px', borderRadius: 10, background: 'var(--bg-input)', border: '1px solid var(--border-input)', minWidth: 200 }}>
